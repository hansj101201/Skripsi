    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDataModalLabel">Detail</h5>
...
@push('js')
    ...
    <script>
        ...
        function simpanData(){
            ...
            // {
            //     arrBarang.push([$('#tableData tr:eq('+i+')').find('td:eq('+0+')').html(), $('#tableData tr:eq('+i+')').find('td:eq('+4+')').html()]);
            // }
                                        ...
                                        while(i < data.length){
                                            ...
                                            createTable +=
                                                `<tr id="${data[i].ID_BARANG}">
                                                    ...
                                                    <td>${data[i].satuan.NAMA}</td>
                                                    <td>${qtyOrder}</td>
                                                    <td>0</td>
                                                    <td class="hide">${data[i].ID_SATUAN}</td>
                                                    <td><button class="btn btn-primary btn-sm edit-button" id="edit-button" data-toggle="modal" data-target="#editDataModal"
                                                        data-kode="${data[i].ID_BARANG}"
                                                        data-nama="${data[i].barang.NAMA}"
                                                        data-satuan="${data[i].satuan.NAMA}"
                                                        data-qtyorder="${qtyOrder}"
                                                        data-qtykirim="${qtyKirim}"
